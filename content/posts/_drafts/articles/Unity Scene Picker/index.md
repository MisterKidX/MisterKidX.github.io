...
title: Unity Scene Picker # title of the post
date: 2024-12-06 # Date of the post, can add time -> T06:00:23+06:00
...
menu:
  sidebar:
    name: Unity Scene Picker # This defines what would be the name of the document in sidebar file hierarchy
    identifier: unity-scene-picker # this will show in the search bar
    weight: 3
    parent: unity
tags: ["t1", "t2"]
